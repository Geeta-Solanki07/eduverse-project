  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="p-4 bg-gray-100 rounded shadow">Total Users</div>
        <div className="p-4 bg-gray-100 rounded shadow">Active Courses</div>
        <div className="p-4 bg-gray-100 rounded shadow">Revenue</div>
      </div>
    </div>
  );
}
